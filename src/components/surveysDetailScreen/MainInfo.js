...
const MainInfo = (props) => {
    ...
    const MainPhoto = props.photos.filter((e) => e.is_main == true)[0]
        ? props.photos.filter((e) => e.is_main == true)[0].image
        : "";
    ...
    const sendPhoto = (type) => {
        ...
        axios
            .post(
                `https://rabbit14.ru/api/surveys/${props.gender}/photos/load_photo/`,
                formData,
                {
    ...
    return (
        <div className={classes.container}>
            ...
            <Box
                ...
                style={{
                    background: `${statusBlogBackground(props.priority)}`,
                }}
            >
            ...
            <Grid container className={classes.imgContainer}>
                {props.photos.map((itemImage, index) => (
                    <Grid
                        ...
                        xs={6}
                        style={{
                            display: itemImage.is_main ? "none" : "block",
                        }}
                    >
                        <img
                            src={itemImage.image}
                            className={classes.soImg}
                            onClick={() => {
                                setOpen(true);
                                dispatch({
                                    type: "photo",
                                    payload: {
                                        name: itemImage.image,
                                        id: itemImage.id,
                                        type: "common",
                                        gender: props.gender,
                                    },
