            ...
            <Container>
                <Grid container className={classes.up_footer_container}>
                    ...
                    <Grid item lg={10} sm={12} md={10} xl={11} xs={12}>
                        <Typography>
                            ДАННЫЙ САЙТ ПРЕДНАЗНАЧЕН ДЛЯ ОБЩЕНИЯ И ПОИСКА ЛЮДЕЙ
                            ПО ИНТЕРЕСАМ, И ТОЛЬКО ДЛЯ ЛИЦ СОВЕРШЕННОЛЕТНЕГО
                            ВОЗРАСТА!
                            <br /> Администрация сайта не размещает анкеты и
                            ответственности за их содержание не несет!
                        </Typography>
                    </Grid>
                </Grid>
                <Box className={classes.under_footer_container}>
                    <Typography>2022 © rabbit14.ru</Typography>
                </Box>
            </Container>
        </div>
    );
