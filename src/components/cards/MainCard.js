    ...
    return (
        <Card className={classes.root}>
            ...
            <CardActionArea
                ...
                onClick={() =>
                    router.push(`/viewingPage/${props.id}`, {
                        id: props.id,
                ...
                <Grid container>
                    <Grid item lg={5} sm={12} md={5} xl={5} xs={12}>
                        <CardMedia
                            ...
                            image={
                                props.photos.filter((e) => e.is_main == true)[0]
                                    ? props.photos.filter(
                                          (e) => e.is_main == true
                                      )[0].image
                                    : "/image/XVP.jpg"
